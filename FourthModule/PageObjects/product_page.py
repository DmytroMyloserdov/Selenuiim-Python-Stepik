...
class ProductPageObject(BasePageObject):
    ...
    def should_product_be_added(self):
        ...
        assert title == added_name, "Wrong product added to busket"

    def should_basket_button_be_presented(self):
        assert self.is_element_exists(*ProductPageObjectLocators.BASKET_LINK), "Busket button" + BasePageObjectLocators.NO_ELEMENT_EXCEPTION
